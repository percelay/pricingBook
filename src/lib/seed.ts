...
export function seedDemoData(): void {
  ...
  const cards: RateCard[] = [
    ...
    },
    {
      ...
      roles: [
        ...
        { role: 'Senior Consultant', dailyRate: 1950, dailyCost: 705 },
        { role: 'Manager',           dailyRate: 2825, dailyCost: 1000 },
        { role: 'Senior Manager',    dailyRate: 3915, dailyCost: 1415 },
        { role: 'Partner',           dailyRate: 5985, dailyCost: 2120 },
        { role: 'Contractor',        dailyRate: 1090, dailyCost: 925 },
      ],
      createdAt: now,
    },
    {
      ...
      currency: 'USD',
      roles: [
        { role: 'Consultant',        dailyRate: 1200, dailyCost: 480 },
        { role: 'Senior Consultant', dailyRate: 1850, dailyCost: 705 },
        { role: 'Manager',           dailyRate: 2610, dailyCost: 1000 },
        { role: 'Senior Manager',    dailyRate: 3700, dailyCost: 1415 },
        { role: 'Partner',           dailyRate: 5650, dailyCost: 2120 },
        { role: 'Contractor',        dailyRate: 1035, dailyCost: 925 },
      ],
      createdAt: now,
    },
    {
      ...
      currency: 'USD',
      roles: [
        { role: 'Consultant',        dailyRate: 1400, dailyCost: 500 },
        { role: 'Senior Consultant', dailyRate: 2050, dailyCost: 740 },
        { role: 'Manager',           dailyRate: 2850, dailyCost: 1010 },
        { role: 'Senior Manager',    dailyRate: 4000, dailyCost: 1450 },
        { role: 'Partner',           dailyRate: 6200, dailyCost: 2200 },
        { role: 'Contractor',        dailyRate: 1150, dailyCost: 950 },
      ],
      createdAt: now,
    },
    {
      ...
      currency: 'USD',
      roles: [
        { role: 'Consultant',        dailyRate: 1550, dailyCost: 500 },
        { role: 'Senior Consultant', dailyRate: 2250, dailyCost: 740 },
        { role: 'Manager',           dailyRate: 3100, dailyCost: 1010 },
        { role: 'Senior Manager',    dailyRate: 4350, dailyCost: 1450 },
        { role: 'Partner',           dailyRate: 6800, dailyCost: 2200 },
        { role: 'Contractor',        dailyRate: 1250, dailyCost: 950 },
      ],
      createdAt: now,
    },
  ];
  ...
  const books: PricingBook[] = [
    ...
    },
    {
      ...
      tePercent: 4,
      lineItems: [
        { id: 'li-8',  role: 'Partner',    name: 'Pierre Dubois',     days: uniformDays(2, 4),               dailyRate: 5650, dailyCost: 2120 },
        { id: 'li-9',  role: 'Manager',    name: 'Elena Marchetti',   days: offset(1, uniformDays(5, 5)),    dailyRate: 2610, dailyCost: 1000 },
        { id: 'li-10', role: 'Consultant', name: 'Amit Kumar',        days: offset(2, uniformDays(10, 5)),   dailyRate: 1200, dailyCost: 480 },
      ],
    ...
    },
    {
      ...
      tePercent: 5,
      lineItems: [
        { id: 'li-16', role: 'Partner',           name: 'Oliver Hartwell',  days: uniformDays(3, 4),              dailyRate: 6800, dailyCost: 2200 },
        { id: 'li-17', role: 'Senior Manager',    name: 'Charlotte Reeves', days: uniformDays(7, 5),              dailyRate: 4350, dailyCost: 1450 },
        { id: 'li-18', role: 'Senior Consultant', name: 'Rohan Mehta',      days: offset(1, uniformDays(8, 5)),   dailyRate: 2250, dailyCost: 740 },
        { id: 'li-19', role: 'Consultant',        name: 'Freya Walsh',      days: offset(2, uniformDays(10, 5)),  dailyRate: 1550, dailyCost: 500 },
      ],
      notes: 'London-based engagement at Canary Wharf. Quarterly partner steering committee included.',
      versions: [],
